...
plt.axis("off")
plt.savefig("mont_analog_wordcloud.png", bbox_inches='tight')
plt.show()
plt.close()
...
ax.set_title('Avg Wordcount and Avg Unique POS Per Sentence')
ax.set_xticks(x)
...
plt.savefig("analog_pos_unique.png")
plt.show()
mpld3.save_html(fig,"analog_pos_unique.html")
...
plt.savefig("analog_words_unique.png")
plt.show()
mpld3.save_html(fig,"analog_words_unique.html")
mpld3.fig_to_html(fig,template_type="simple")
...
plt.savefig("analog_words_total_words.png")
plt.show()

mpld3.save_html(fig,"analog_words_total_words.html")
mpld3.fig_to_html(fig,template_type="simple")
...
ax.set(xlabel='Sentence Number', ylabel='Sentence Length',
       title='Mont Analog')
ax.grid()

plt.savefig("analog_words_avg_words.png")
plt.show()

mpld3.save_html(fig,"analog_words_avg_words.html")
mpld3.fig_to_html(fig,template_type="simple")
...
plt.savefig("analog_words_long_words.png")
plt.show()

mpld3.save_html(fig,"analog_words_long_words.html")
mpld3.fig_to_html(fig,template_type="simple")
